        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="text-right text-danger">Add a Book</h4>
                </div>
                <div class="row mt-2">
                    <div class="col-md-6"><label class="labels">Name of Book</label><input required name="pro_name" type="text" class="form-control" value=""></div>
                    
                </div>
                
                <div class="row mt-3">
                    <div class="col-md-12"><label class="labels">Mobile Number</label><input required type="text" class="form-control" value=""></div>
                    <div class="col-md-12"><label class="labels">Description of Book</label><textarea name="description" class="form-control" id=""  rows="5"></textarea></div>
                </div>
                <div class="row mt-3">
             ...
             <option value="electronics">Novel</option>
             <option value="books">Fiction</option>
            <option value="sports">Sports</option>
            <option value="music">Religiom</option>
            <option value="mobile">History</option>
            <option value="applications">Romantic</option>
