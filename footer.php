...
<footer class="bg-dark text-center text-white">
    ...
    <section class="">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
          ...
          <ul class="list-unstyled mb-0">
            <li>
              <a href="#!" class="text-white">Kerela</a>
            </li>
            <li>
              <a href="#!" class="text-white">Karnataka</a>
            </li>
            <li>
              <a href="#!" class="text-white">Tamilnadu</a>
            </li>
        ...
        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
          ...
          <ul class="list-unstyled mb-0">
            ...
            <li>
              <a href="#!" class="text-white">Motives</a>
            </li>
            <li>
  ...
  <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
    © 2020 Copyright:
    <a class="text-white" href="https://mdbootstrap.com/">pranav@gmail.com</a>
  </div>
